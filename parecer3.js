...
function json(){
	...
	json.prototype.resgatarJson = function(){
      ...
      this.retorno = '<br><br><left><h3><shadow>ID do Docente: ' +data.id+'</shadow></h3></left><br>';
      this.retorno += '<center><h3><shadow><tab2>Artigo 39<tab2></h3></shadow></center>';
      ...
      this.retorno += '<center><h3><shadow><tab2>Artigo 40<tab2></h3></center></left>';
      ...
      this.retorno += '<left><font size="4">Inciso V:<tab1><strong>'+data.totalMeses +'</strong></font></left><br><br>';
      this.retorno += '<left><font size="4">Inciso VI:<tab1><strong>'+data.aprovadoChefia +'</strong></font></left><br><br>';

      this.retorno += '<center><h3><shadow><tab2>Somatórios Finais<tab2></h3></shadow></center>';
      ...
      this.retorno += '<center><h3><shadow><tab2>Habilitação<tab2></h3></shadow></center>';
