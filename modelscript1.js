...
function json(){
    ...
    json.prototype.resgatarJson = function(){
        ...
        $.getJSON('arquivo.json', function(data){
            ...
            this.retorno +='<tr><td rowspan="4">(Art. 39) Nota final: <div>' + data.notaFinal + '</div></td></tr>';
            this.retorno +='<tr><td>(Art. 39) Total de meses: ' +data.totalMeses + '</td></tr>';
            this.retorno +='<tr><td>(Art. 39) Verifica numero de meses: ' +data.meses24 + '</td></tr>';
            this.retorno +='<tr><td>(Art. 39) Somatório ponderado: ' +data.somaPonderada + '</td></tr>';
